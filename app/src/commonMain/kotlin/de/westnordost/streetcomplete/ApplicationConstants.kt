...
object ApplicationConstants {
    ...
    val USER_AGENT = PARENT_NAME + " " + BuildConfig.VERSION_NAME
    val OSM_USER_AGENT = "Zazolc" + " " + BuildConfig.VERSION_NAME // crashes: JNI DETECTED ERROR IN APPLICATION: JNI NewString called with pending exception java.lang.IllegalArgumentException: Unexpected char 0x17c at 2 in User-Agent value: zażółć 17.3 / okhttp/3.12.0
