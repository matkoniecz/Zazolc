...
open class UpdateTaginfoListingTask : DefaultTask() {
    companion object {
        ...
        val EXPECTED_TAG_PER_QUEST = mapOf(
            ...
            "air_pump/AddAirCompressor.kt" to setOf(Tag("compressed_air", "yes"), Tag("compressed_air", "no")),
            ...
            "bike_shop/AddSecondHandBicycleAvailability.kt" to setOf(Tag("service:bicycle:second_hand", "no"), Tag("service:bicycle:second_hand", "yes"), Tag("service:bicycle:second_hand", "only"), Tag("service:bicycle:retail", "no"), Tag("service:bicycle:retail", "yes")),
            ...
            "pitch_lit/AddPitchLit.kt" to setOf(Tag("lit", "yes"), Tag("lit", "no")),
            ...
            "tactile_paving/AddTactilePavingBusStop.kt" to setOf(Tag("tactile_paving", "yes"), Tag("tactile_paving", "no")),
            "tactile_paving/AddTactilePavingKerb.kt" to setOf(Tag("barrier", "kerb"), Tag("tactile_paving", "yes"), Tag("tactile_paving", "no")),
