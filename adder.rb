...
def manually_licenced_files
    ...
    manually_licenced << {licence: "CC-BY-SA-4.0", file: "#{root_folder}/res/sport_icons.svg", author: "Tobias Zwick (american_football, athletics, australian_football, baseball, boules, bowls, canadian_football, handball, ice_stock, racquetball, paddle_tennis, sepak_takraw, skateboard, softball, skating) on CC-BY-SA 4.0; archery, shooting by Twemoji with subsequent work by Tobias Zwick (MIT, relicenced to CC-BY-SA-4.0); Twemoji (equestrian, golf) on MIT, relicenced to CC-BY-SA-4.0; EmojiOne 2 (badminton, basketball, cricket, field_hockey, ice_hockey, ice_skating, rugby, soccer, table_tennis, tennis, volleyball) on CC-BY-4.0 license; gymnastics, netball, gaelic_games, squash (EmojiOne 2 and Tobias Zwick on CC-BY-SA-4.0); beach_volleyball by Adrien Pavie, modified from EmojiOne 2"}
