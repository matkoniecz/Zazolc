...
def made_by_main_author
    return [
        ...
        "#{root_folder}/res/drawable-mdpi/quest_pin.png",
        "#{root_folder}/res/drawable-hdpi/quest_pin.png",
        "#{root_folder}/res/drawable-xhdpi/quest_pin.png",
        "#{root_folder}/res/drawable-xxhdpi/quest_pin.png",
